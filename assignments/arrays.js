...
let car = inventory.filter(car => car.id == 33)[0]
console.log(`Car 33 is a ${car.car_year} ${car.car_make} ${car.car_model}`)
...
// let oldCars = [];
// for (let car of carYears) {
//     if (car < 2000) oldCars.push(car)
// }
...
//console.log(carYears.reduce((acc, car) => car < 2000 ? acc + 1 : acc, 0))
...
// let BMWAndAudi = [];
// for (let car of inventory) {
//     if (/BMW|Audi/.test(car.car_make)) BMWAndAudi.push(car)
// }
// console.log(JSON.stringify(BMWAndAudi, null, '  '));

let BMWAndAudi = inventory.filter(car => /BMW|Audi/.test(car.car_make))
console.log(JSON.stringify(BMWAndAudi, null, '  '));
